...
<div class="col-lg-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form action="{{ route('deals.update', ['deal' => $deal]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
...
@section('extra-script')
    ...
    <script> 
        ...
        firstUpload.addImagesFromPath(['{{'/images/' . $deal->image}}']);
        ...
        $priceDetailsContainer = $('#priceDetailsContainer');
            ...
            @if(isset($deal) && $deal->deal_type == 'deal')
                {!! '$dealTypeField.val("deal")' !!}
                @elseif(isset($deal) && $deal->deal_type == 'code')
                    {!! '$copyCodeContainer.css("display", "block")' !!} 
                    {!! '$dealTypeField.val("code")' !!}   
                @elseif(isset($deal) && $deal->deal_type == 'coupon')
