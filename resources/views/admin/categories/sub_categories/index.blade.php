                                            ...
                                            <td class="text-center">
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('sub_categories.edit', ['sub_category' => $subCat]) }}">Edit</a>
                                                        <form method="POST" action="{{ route('sub_categories.destroy', ['sub_category' => $subCat]) }}">
                                                            @csrf
                                                            @method('DELETE')
